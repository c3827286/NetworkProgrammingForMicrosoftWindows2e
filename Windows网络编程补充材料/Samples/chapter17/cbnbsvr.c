...
//    callback functions as opposed to asynch events.  The server will
//    add its name to each LANA number on the machine and post a listen
//    (NCBLISTEN) on each LANA in order to service client requests.
//
// Compile:
//    cl -o cbnbsvr cbnbsvr.c ..\Common\nbcommon.obj netapi32.lib
//
// Command Line Options:
//    NONE - The server automatically uses the NetBIOS name as defined
//           by the constant SERVER_NAME
//
#include <windows.h>
#include <stdio.h>
#include <stdlib.h>
