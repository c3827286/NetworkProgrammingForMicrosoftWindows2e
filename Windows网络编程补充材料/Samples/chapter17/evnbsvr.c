...
//    post asynch listens on each LANA using events.  Wait for
...
int main(int argc, char **argv)
{
    ...
    {        
        ...
        // succeeded.  If ncb_cmd_plt is not NRC_PENDING then there is
        // a client, create a thread and hand off a new NCB structure
        // to the thread.  We need to re-use the original NCB for other
        // client connections.
        //
        for(i=0; i < lenum.length ;i++)
        {
